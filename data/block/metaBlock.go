//go:generate protoc -I=. -I=$GOPATH/src -I=$GOPATH/src/github.com/Reshusk23/protobuf/protobuf  --gogoslick_out=. metaBlock.proto
package block
...
import (
	...
	"github.com/Reshusk23/sr-me-core/data/headerVersionData"
)
